...
namespace DefaultTables\ModelBundle\Controller;
...
use DefaultTables\ModelBundle\Entity\Categories;
use DefaultTables\ModelBundle\Form\CategoriesType;
...
class CategoriesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DefaultTablesModelBundle:Categories')->findAll();
     ...
     * @Method("POST")
     * @Template("DefaultTablesModelBundle:Categories:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DefaultTablesModelBundle:Categories')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("DefaultTablesModelBundle:Categories:edit.html.twig")
     */
