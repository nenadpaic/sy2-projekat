...
class GroupTopicCommentReply
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Users\ModelBundle\Entity\User", inversedBy="group_topic_comment_reply",cascade={"persist",
     * "remove"}))
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Groups\ModelBundle\Entity\GroupTopicComment", inversedBy="group_topic_comment_reply",cascade={"persist",
     * "remove"}))
